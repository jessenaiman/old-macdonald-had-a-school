...
export const GRADE_INTERACTION_CONFIGS = {
  ...
  "pre-school": {
    gradeKey: "pre-school", grade: "Pre-School", age: "Ages 3–4", reminder: "Leave room for choice and change.", eyebrow: "Welcome back, teacher", headline: "Grow confidence through", accentHeadline: "story and sensation.", leadName: "Miss Maisy", leadImage: "/staff_and_students/miss-maisy-transparent-circle.png", leadQuote: "What can they choose, try, and tell us about?", teacherClass: "cast-miss-maisy",
  },
  kindergarten: {
    gradeKey: "kindergarten", grade: "Kindergarten", age: "Ages 4–6", reminder: "Find the beat and help everyone join in.", eyebrow: "Choose a starting point", headline: "Turn rhythm into", accentHeadline: "a day of discovery.", leadName: "Mr Rusty", leadImage: "/staff_and_students/mr-rusty-transparent-circle.png", leadQuote: "Can you find and keep the steady beat with me?", teacherClass: "cast-mr-rusty",
  },
  "grade-one": {
    gradeKey: "grade-one", grade: "Grade 1", age: "5–6 yrs", reminder: "Invite a choice. Notice the story.", eyebrow: "Choose a starting point", headline: "Think, create, and", accentHeadline: "share with purpose.", leadName: "Miss Hayley", leadImage: "/staff_and_students/miss-hayley-transparent-circle.png", leadQuote: "What can they notice, explain, and share today?", teacherClass: "cast-miss-hayley",
  },
  "grade-two": {
    gradeKey: "grade-two", grade: "Grade 2", age: "6–7 yrs", reminder: "Ask for evidence and another way.", eyebrow: "Choose a starting point", headline: "Ask deeper, solve bigger,", accentHeadline: "and learn together.", leadName: "Mr Maisy", leadImage: "/staff_and_students/mr-maisy-transparent-circle.png", leadQuote: "What evidence will help them explain their thinking?", teacherClass: "cast-mr-maisy",
  },
