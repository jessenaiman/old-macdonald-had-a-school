    ...
    <div className={styles.headerInner}>
      ...
      <NavigationMenu className={styles.desktopNav} aria-label="Primary navigation" viewport={false}>
        <NavigationMenuList className={styles.primaryList}>
          ...
          <NavigationMenuItem><NavigationMenuLink asChild active={active === "songs"}><Link className={styles.navLink} href="/songs" aria-current={active === "songs" ? "page" : undefined}>For Teachers</Link></NavigationMenuLink></NavigationMenuItem>
