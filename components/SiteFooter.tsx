...
export function SiteFooter() {
  return <footer className={styles.footer}>
    <span className={`${styles.footerFastener} ${styles.footerFastenerLeft} brand-asset fastener-brass-rivet`} aria-hidden="true" />
    <span className={`${styles.footerFastener} ${styles.footerFastenerRight} brand-asset fastener-brass-rivet`} aria-hidden="true" />
    <Card className={`${styles.footerCard} typeset-farm-ui mx-auto max-w-7xl gap-0 border-0 bg-transparent px-5 py-0 text-inherit shadow-none sm:px-8`}>
