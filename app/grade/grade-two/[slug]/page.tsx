...
import styles from "../../../../components/grades/grade-two/GradeTwoTemplate.module.css";
...
export default async function Page({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <GradeLessonPage slug={slug} grade="grade-two" active="grade-two" className={styles.template} />;
}
