  ...
  return (
    <section className="my-7 text-foreground max-sm:my-3" aria-labelledby="lessons-index-title">
        <header className="bg-brand-navy text-brand-navy-foreground rounded-2xl border border-brand-navy-foreground/10 px-6 py-8 sm:px-10 sm:py-12 shadow-[0_8px_0_color-mix(in_srgb,var(--border)_28%,transparent)]">
          <div>
            <p className="m-0 font-body text-xs font-black leading-tight tracking-[.12em] text-brand-navy-foreground/70 uppercase">Teacher planning library</p>
            ...
            <p className="m-0 max-w-3xl font-body text-sm font-semibold leading-relaxed text-brand-navy-foreground/80">Start with a skill, song, or classroom moment. Teacher-ready lessons appear first, with planning records clearly marked for further review.</p>
          </div>
