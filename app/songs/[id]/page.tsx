...
export default async function SongPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <div className="material-surface material-cardboard-paper min-h-dvh px-4 py-8 text-foreground sm:px-6 lg:px-8 lg:py-14 print:bg-none print:p-0 print:text-black"><article className="flex w-full flex-col gap-6">
