...
| --- | --- | --- | --- | --- | --- | --- |
| PAM-CORK-002 | Derive complete governed production kit | `public/design-assets/cork-board-kit-v2/muted-natural-cork-tile-v01.png` | `public/design-assets/cork-board-kit-v2/` seamless tile, medium landscape board, tall mobile board, wide planning strip, source counterparts, and review sheet | Complete the preferred softened cork family with every production role previously available only in v1; deterministic build script: `scripts/build-cork-board-kit-v2.py` | Original v2 source and complete v1 kit remain untouched; v2 derivatives and mappings are independently reversible | APPROVED by user request 2026-08-13 |
| PAM-NOTE-001 | Generate review family and separate transparent derivatives | New original image-generation source, visually guided by `qa/homepage-concepts/revised-option-1.png` and the approved construction-paper material family | Source sheet: `public/design-assets/classroom-paper-notes-v1-review/classroom-paper-notes-sheet-v01.png`; production derivatives: `public/design-assets/classroom-paper-notes-v1/individual-notes/` | Add responsive blank teacher-note silhouettes that can hold semantic HTML text, approved icons, and independently positioned fasteners; no text, icons, or fasteners baked into the raster assets | Source sheet and derivatives are independently replaceable; no existing asset overwritten | APPROVED by user on 2026-08-13; independent desktop/mobile rendered QA passed |
| PAM-LOGO-001 | Create a review-only three-tier emblem family and deterministic size exports | Composition: `public/brand-emblem.png`; 2D style: `public/icons/farm_school_character_face_patch_sheet_primary_secondary_16.png`; generated flat source retained in review directory | `public/design-assets/brand-emblem-v1/` individual flat, digital, and detail candidates; `public/design-assets/brand-emblem-v1-review/brand-emblem-family-contact-sheet.png` | Provide micro/nav, screen, and larger-media candidates without changing the active site emblem; document missing green-tree source rather than inventing one | Original remains active and untouched; all candidates and build script are independently removable | APPROVED for candidate creation by user on 2026-08-13; production replacement requires separate candidate approval |
...
| PAM-FASTENER-001 | Remove flat magenta chroma background from generated top-view rivet | `C:/Users/jesse/.codex/generated_images/019ff0a1-89b3-7c90-849e-c8dbff9cb2be/exec-c14eee8f-906f-460a-ab8c-43983b54a460.png` (1254x1254) | `public/design-assets/classroom-fasteners-v1/individual-icons/17-brass-rivet-top-v01.png` | Replace the angled split pin in the leather footer with the explicitly requested straight-down punched-rivet view | Generated source retained; new transparent PNG removable | APPROVED by user request 2026-08-11 |
