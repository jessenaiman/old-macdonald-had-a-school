...
export const EARLY_YEARS: Record<EarlyYearsGradeKey, EarlyYearsTopic[]> = {
  daycare: [
    ...
    { grade: "daycare", slug: "open-circle-gathering", title: "Old Mac's Open Circle", focus: "Group gathering and turn-taking", patch: "penny", image: "/scenes/hero/old-macs-open-circle-gathering.png", steps: ["Sit together", "Listen", "Take a turn"] },
