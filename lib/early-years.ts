...
export const EARLY_YEARS: Record<EarlyYearsGradeKey, EarlyYearsTopic[]> = {
  daycare: [
    { grade: "daycare", slug: "follow-the-duckling", title: "Follow the Duckling", focus: "Animal sounds and simple imitation", patch: "puddles", image: "/scenes/follow-the-duckling.webp", steps: ["Listen", "Name", "Copy the sound"] },
    { grade: "daycare", slug: "open-circle-gathering", title: "Old Mac's Open Circle", focus: "Group gathering and turn-taking", patch: "penny", image: "/scenes/hero/old-macs-open-circle-gathering.webp", steps: ["Sit together", "Listen", "Take a turn"] },
    ...
    { grade: "daycare", slug: "singing-together", title: "Singing Together", focus: "Whole-school music circle", patch: "scout", image: "/scenes/singing-together-on-old-macs-farm.webp", steps: ["Listen", "Hum along"] },
  ],
  "pre-school": [
    { grade: "pre-school", slug: "clap-your-hands-2", title: "Clap Your Hands", focus: "Steady beat, hands and feet, faster tempo", patch: "hopper", image: "/scenes/clap-your-hands-2.webp", steps: ["Identify", "Imitate", "Move", "Join In"], choice: ["Standing", "Seated", "Gesture only", "Watch and listen"], noticeFor: ["Copies the beat", "Joins without a prompt", "Notices tempo change"] },
    { grade: "pre-school", slug: "plant-your-seeds-with-care", title: "Plant Your Seeds With Care", focus: "Sequenced fingerplay with a growing pattern", patch: "maisy", image: "/scenes/plant-your-seeds-with-care.webp", steps: ["Identify", "Imitate", "Move", "Join In"], choice: ["Full motion", "Hands only", "Watch and listen"], noticeFor: ["Follows the sequence", "Names the next step", "Repeats independently"] },
    { grade: "pre-school", slug: "seven-jumps-2", title: "Seven Jumps", focus: "Counted movement with a freeze cue", patch: "rusty", image: "/scenes/seven-jumps-2.webp", steps: ["Identify", "Imitate", "Move", "Join In"], choice: ["Standing", "Seated", "Gesture only"], noticeFor: ["Counts along", "Freezes on cue", "Recovers after a miss"] },
    ...
    { grade: "pre-school", slug: "worksheet-example", title: "A Barn Band Day", focus: "Instruments, sound and simple choice-making", patch: "whiskers", image: "/scenes/early-years-worksheet-example.webp", steps: ["Identify", "Imitate", "Move", "Join In"], choice: ["Shaker", "Drum", "Voice only"], noticeFor: ["Chooses an instrument", "Keeps the beat briefly", "Shares with a peer"] },
  ],
  kindergarten: [
    { grade: "kindergarten", slug: "barnyard-count-along", title: "Barnyard Count-Along", focus: "Counting the animals as they appear on the page", patch: "sam", image: "/scenes/singing-together-on-old-macs-farm.webp", steps: ["Look", "Count", "Mark the picture"] },
    { grade: "kindergarten", slug: "sound-and-letter-walk", title: "Sound & Letter Walk", focus: "Matching an animal sound to its starting letter", patch: "whiskers", image: "/scenes/hero/old-macs-open-circle-gathering.webp", steps: ["Listen", "Find the letter", "Mark the picture"] },
  ],
};
